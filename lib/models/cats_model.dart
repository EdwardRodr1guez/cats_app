...
//
//     final catsModel = catsModelFromMap(jsonString);

import 'dart:convert';

List<CatsModel> catsModelFromMap(String str) =>
    List<CatsModel>.from(json.decode(str).map((x) => CatsModel.fromMap(x)));

String catsModelToMap(List<CatsModel> data) =>
